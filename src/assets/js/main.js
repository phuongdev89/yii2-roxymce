...
function dragFileOver() {
	$(this).children('img.dir').attr('src', roxyMceAsset + '/images/folder-green.png');
}
function dragFileOut() {
	$('#pnlDirList').find('img.dir').attr('src', roxyMceAsset + '/images/folder.png');
}
...
function makeDragDir(e) {
	...
	return '<div class="pnlDragDir" data-path="' + f.fullPath + '"><img src="' + roxyMceAsset + '/images/folder.png" align="absmiddle">&nbsp;' + f.name + '</div>';
}
...
function switchView(t) {
	...
	if(t == 'thumb') {
		$('#pnlFileList .icon').attr('src', roxyMceAsset + '/images/blank.gif');
