...
namespace phuongdev89\roxymce\widgets;

use phuongdev89\roxymce\assets\TinyMceAsset;
...
class RoxyMceWidget extends Widget
{
     ...
     * @see https://github.com/phuongdev89/yii2-roxymce/blob/master/docs/widget.md
     */
    public $options;
